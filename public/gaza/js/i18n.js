...
(function () {
  ...
  const D = {
    ...
    "b.westbank": { de: "nicht Gaza: Judäa & Samaria (J&S)", en: "not Gaza: West Bank (J&S)", ar: "ليس غزة: الضفة الغربية", he: "לא עזה: יהודה ושומרון" },
    "b.abroad":   { de: "nicht Gaza: international / Exil", en: "not Gaza: international / exile", ar: "ليس غزة: دولي / منفى", he: "לא עזה: בינלאומי / גלות" },
    "fam.js.note":{ de: "Diese Familie kommt in der Gaza-Opferliste nicht vor — geführt wird sie hier mit dokumentierten Personen, die nicht in Gaza lebten, sondern in Judäa & Samaria (Westjordanland) oder international im Exil.",
                    en: "This family does not appear in the Gaza casualty list — it is listed here with documented persons who did not live in Gaza but in the West Bank (Judea & Samaria) or in exile abroad.",
                    ar: "هذه العائلة غير واردة في قائمة ضحايا غزة — تُدرج هنا مع أشخاص موثقين لم يعيشوا في غزة بل في الضفة الغربية أو في المنفى.",
                    he: "משפחה זו אינה מופיעה ברשימת ההרוגים בעזה — היא מוצגת כאן עם אנשים מתועדים שלא התגוררו בעזה אלא ביהודה ושומרון או בגלות." },
